...
class JustCoded_PCIAuth_Model_Customer_Customer extends Mage_Customer_Model_Customer
{
    ...
    protected function _updatePasswordHistory()
    {
        ...
        $passwordHistory = Mage::getModel(self::PASSWORD_HISTORY_MODEL_CLASS_CODE);
